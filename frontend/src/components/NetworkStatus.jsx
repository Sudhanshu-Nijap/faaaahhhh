...
const NetworkStatus = () => {
  return (
    <div className="max-w-7xl mx-auto px-6">
      <div className="glass-panel rounded-[40px] p-12 relative overflow-hidden border-white/5 bg-slate-900/40">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <p className="text-slate-500 text-xs md:text-sm leading-relaxed font-outfit uppercase tracking-widest opacity-80 max-w-sm">
            ...
            <div className="grid grid-cols-2 gap-8 pt-8">
              <div>
                ...
                <p className="text-[10px] font-black tracking-industrial text-slate-500 uppercase mt-2">Uptime Core</p>
              </div>
              <div>
                <p className="text-3xl font-black text-white">0.08s</p>
                <p className="text-[10px] font-black tracking-industrial text-slate-500 uppercase mt-2">API Latency</p>
              </div>
            </div>
          </div>

          <div className="lg:col-span-7 relative">
            <div className="glass-panel p-8 rounded-[32px] border border-white/10 bg-black/40 shadow-neon-strong backdrop-blur-2xl">
              <div className="flex justify-between items-center mb-10">
                <div className="flex items-center gap-4">
                   <div className="size-3 bg-emerald-500 rounded-full animate-pulse shadow-[0_0_12px_rgba(16,185,129,0.5)]" />
                   <span className="text-[10px] font-black tracking-industrial text-white uppercase">Operational Network Map</span>
                </div>
                <div className="px-4 py-1.5 bg-white/5 rounded-full border border-white/10 text-[9px] font-black tracking-widest text-slate-400 uppercase">
                   V6.4.2_NODE_SECURE
                </div>
              </div>
              ...
              {[
                ...
                { label: "AI_CLASSIFIER_LR", status: 100, color: "bg-emerald-500" },
                { label: "DB_PERSISTENCE", status: 94, color: "bg-blue-500" },
            ...
            <div className="absolute -bottom-8 -left-12 size-20 glass-panel rounded-2xl border border-white/10 flex items-center justify-center -z-10 -rotate-6 bg-slate-900">
