...
const AboutUs = () => {
  ...
  return (
    <section className="w-full flex flex-col items-center">
      <div className="max-w-6xl w-full mx-auto flex flex-col lg:flex-row gap-12 lg:gap-32 px-6">
        <div className="w-full lg:w-5/12 py-8 lg:py-12">
          <motion.h2 
            initial={{ opacity: 0, x: -60 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            className="font-outfit text-4xl sm:text-5xl lg:text-6xl font-black mb-10 lg:mb-12 leading-tight premium-gradient-text uppercase py-2"
          >
          ...
          <div className="grid grid-cols-1 gap-10 lg:gap-12">
            {[
              ...
              <div key={i} className="flex flex-col gap-2">
                ...
                <p className="text-slate-400 font-outfit text-xs sm:text-sm uppercase tracking-widest leading-relaxed">
                  {spec.detail}
                </p>
              </div>
            ))}
        ...
        <div className="flex-1 lg:pl-10">
          <motion.div 
            ...
            className="relative group h-full flex flex-col justify-center py-10 lg:py-0"
          >
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* Main Spec Card */}
              <div className="sm:col-span-2 glass-panel p-6 rounded-[32px] border-white/5 bg-slate-900/40 border grid grid-cols-1 md:grid-cols-[auto_1fr] items-start gap-6 lg:gap-8">
                <div className="relative shrink-0 mx-auto md:mx-0">
                  <div className="absolute inset-0 bg-primary/20 blur-2xl rounded-full animate-pulse" />
                  <div className="relative size-20 lg:size-24 bg-slate-950 border border-white/10 rounded-[28px] flex items-center justify-center shadow-2xl">
                     <Cpu size={40} className="text-primary glow-primary animate-float" />
                  </div>
                </div>
                <div className="text-center md:text-left pt-2">
                   ...
                   <div className="space-y-3">
                      <div className="flex items-center justify-center md:justify-start gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 shadow-neon" />
                        <span className="text-[9px] font-black tracking-industrial text-slate-400 uppercase">System Integrity: Optimal</span>
                      </div>
              ...
              {/* Stat Card 1 */}
              <div className="glass-panel p-4 pb-5 rounded-[24px] border-white/5 bg-slate-900/40 border">
              ...
              {/* Terminal Code Block */}
              <div className="sm:col-span-2 glass-panel p-5 rounded-[24px] border-white/5 bg-black/40 border overflow-hidden">
                <div className="flex items-center gap-2 mb-3">
                  <div className="size-1.5 rounded-full bg-rose-500/40" />
                  <div className="size-1.5 rounded-full bg-amber-500/40" />
                  <div className="size-1.5 rounded-full bg-emerald-500/40" />
                  <span className="ml-1 text-[7px] font-black text-slate-600 uppercase tracking-widest">Initialization_Log</span>
                </div>
